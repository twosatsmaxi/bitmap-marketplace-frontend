        ...
        <div className="mx-auto flex w-full max-w-7xl items-center gap-6 md:gap-8">
          ...
          <div className="ml-auto flex items-center gap-3">
            ...
            <button
              ...
              className="flex h-9 w-9 items-center justify-center border border-[rgba(120,72,18,0.55)] bg-[rgba(247,147,26,0.06)] text-zinc-400 transition-colors hover:text-primary md:hidden"
