        ...
        return (
          <div
            ...
            ref={(el) => {
              ...
              if (isConfirming && el) (confirmRef as React.MutableRefObject<HTMLDivElement | null>).current = el;
            }}
          ...
          >
            {isConfirming ? (
              <button
                ...
                className="w-full font-mono text-[11px] font-bold text-red-400 text-center transition-colors hover:text-red-300"
              >
                Remove?
              </button>
            ) : (
