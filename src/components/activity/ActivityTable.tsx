...
export default function ActivityTable({ events }: ActivityTableProps) {
  ...
  return (
    <>
      {/* Desktop Table */}
      <div className="hidden md:block overflow-x-auto border border-[rgba(120,72,18,0.55)] bg-black/30 hide-scrollbar">
      ...
      {/* Mobile Cards */}
      <div className="md:hidden border border-[rgba(120,72,18,0.55)] rounded-lg overflow-hidden">
        {events.map((event) => (
