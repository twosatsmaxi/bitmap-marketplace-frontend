...
export default function MetadataPanel({ bitmap }: { bitmap: Bitmap }) {
  ...
  return (
    <div className="br-card px-5 py-5">
      <h2 className="mb-4 border-b border-[rgba(255,255,255,0.08)] pb-2 font-mono text-xl font-bold uppercase text-primary">Properties</h2>
      ...
      <div className="mt-6 border-t border-[rgba(255,255,255,0.08)] pt-4">
        ...
        <div className="grid grid-cols-2 gap-3">
          <div className="flex flex-col items-center justify-center rounded-lg border border-[rgba(255,255,255,0.08)] bg-black/45 p-3 text-center">
