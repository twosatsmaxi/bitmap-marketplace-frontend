      ...
      <div className="max-w-[1400px] mx-auto px-4 md:px-6 py-4 md:py-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 md:gap-6 mb-4 md:mb-8">
          <div className="home-panel p-4 md:p-6">
            <h2 className="font-mono text-base md:text-xl font-bold uppercase text-primary mb-4 md:mb-6">
              Floor Price History
            </h2>
            <div className="h-[220px] md:h-[280px] lg:h-[350px]">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 md:gap-6">
          <div className="lg:col-span-2 home-panel p-4 md:p-6">
            ...
            <div className="h-[220px] md:h-[280px] lg:h-[300px]">
          ...
          <div className="home-panel p-4 md:p-6">
            ...
            <div className="h-[250px] md:h-[280px] lg:h-[300px]">
